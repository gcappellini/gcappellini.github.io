...
<div class="research-nav">
  <a href="/publications/" class="research-nav-item">
    <h3>📚 Publications</h3>
    <p>Papers, conference proceedings, and journal articles</p>
  </a>
  
  <a href="/talks/" class="research-nav-item">
    <h3>🎤 Talks</h3>
    <p>Conference presentations and invited lectures</p>
  </a>
  
  <a href="/teaching/" class="research-nav-item">
    <h3>👨‍🏫 Teaching</h3>
    <p>Courses, supervision, and educational activities</p>
  </a>
  
  <a href="/cv/" class="research-nav-item">
    <h3>📄 CV</h3>
